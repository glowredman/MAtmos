...
public class StreamHandle<T extends StreamingSound> {
    ...
    /** This doesn't set the stream's volume immediately. Instead, the volume gets applied in SoundHelper.routine(),
     * after all machines have been ticked. 
     * If multiple volume values are set during the same tick, the largest one wins.
     */
