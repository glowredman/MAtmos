...
/**
 * <p>This class transformer loads SoundSystem classes embedded in the mod's jar, and 
 * replaces SoundSystem classes with them, discarding any previous transformations.</p>
 * 
...
public class SoundSystemReplacerTransformer implements IClassTransformer{
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if(name.startsWith("paulscode.")) {
            ...
            if(newData.isPresent()) hasMadeChanges = true;
