...
public interface Module extends Processor, Named {
    ...
    /**
     * This is a magic value to designate a block that is outside the world's actual bounds
     */
    String NO_BLOCK_OUT_OF_BOUNDS = "";

    /**
     * This is a magic value to designate a failed detection of block that is unrelated to the world
     * height.
     */
