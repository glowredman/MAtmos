...
public class ModuleLegacy extends ModuleProcessor implements Module {
    ...
    protected void doProcess() {
        ...
        setValue("armor_0_as_number", number(ExpansionManager.dealias(player.inventory.armorInventory.get(0), data)));
        setValue("armor_1_as_number", number(ExpansionManager.dealias(player.inventory.armorInventory.get(1), data)));
        setValue("armor_2_as_number", number(ExpansionManager.dealias(player.inventory.armorInventory.get(2), data)));
        setValue("armor_3_as_number", number(ExpansionManager.dealias(player.inventory.armorInventory.get(3), data)));
