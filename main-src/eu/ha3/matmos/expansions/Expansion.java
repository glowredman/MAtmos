...
public class Expansion implements VolumeUpdatable, Stable, Simulated, Evaluated {
    ...
    public Expansion(ExpansionIdentity identity, Data data, Collector collector, SoundAccessor accessor, VolumeContainer masterVolume, File configurationSource) {
