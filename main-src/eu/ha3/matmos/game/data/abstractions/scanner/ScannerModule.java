...
public class ScannerModule implements PassOnceModule, ScanOperations, Progress {
     ...
     * @param blocksPerCall
     */
    public ScannerModule(Data data, String passOnceName, String baseName, boolean requireThousand, int movement, int pulse, int xS, int yS, int zS, int blocksPerCall) {
