...
import eu.ha3.matmos.game.data.modules.items.ModulePotionDuration;
import eu.ha3.matmos.game.data.modules.items.ModulePotionStrength;
import eu.ha3.matmos.game.data.modules.legacy.ModuleLegacy;
import eu.ha3.matmos.game.data.modules.legacy.ModuleLegacyColumn;
import eu.ha3.matmos.game.data.modules.legacy.ModuleLegacyHitscan;
import eu.ha3.matmos.game.data.modules.legacy.ModuleDice;
import eu.ha3.matmos.game.data.modules.legacy.ModuleModData;
import eu.ha3.matmos.game.data.modules.mount.ModuleRiding;
import eu.ha3.matmos.game.data.modules.mount.ModuleHorse;
import eu.ha3.matmos.game.data.modules.mount.ModuleRidingMotion;
import eu.ha3.matmos.game.data.modules.legacy.ModuleConfigVars;
import eu.ha3.matmos.game.data.modules.player.ModuleAction;
import eu.ha3.matmos.game.data.modules.player.ModuleArmour;
import eu.ha3.matmos.game.data.modules.player.ModuleArmourEnchantment;
import eu.ha3.matmos.game.data.modules.player.ModulePlayerStats;
import eu.ha3.matmos.game.data.modules.player.ModuleHeldEnchantment;
import eu.ha3.matmos.game.data.modules.player.ModuleInventory;
import eu.ha3.matmos.game.data.modules.player.ModuleMotion;
import eu.ha3.matmos.game.data.modules.player.ModuleStats;
import eu.ha3.matmos.game.data.modules.world.ModuleBiome;
import eu.ha3.matmos.game.data.modules.world.ModuleCollission;
import eu.ha3.matmos.game.data.modules.world.ModuleColumn;
import eu.ha3.matmos.game.data.modules.world.ModuleLighting;
import eu.ha3.matmos.game.data.modules.world.ModulePosition;
import eu.ha3.matmos.game.data.modules.world.ModuleWorld;
import eu.ha3.matmos.game.data.modules.player.ModuleHitscan;
import eu.ha3.matmos.game.data.modules.player.ModuleLeashing;
