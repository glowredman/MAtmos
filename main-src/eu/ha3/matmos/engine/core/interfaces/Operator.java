...
public enum Operator {
    ...
    public static Operator fromSerializedForm(String serializedForm) {
        if (serializedForm == null || !fromSerializedForm.containsKey(serializedForm)) return Operator.ALWAYS_FALSE;
    ...
    public static Operator fromSymbol(String symbol) {
        if (symbol == null || !fromSymbol.containsKey(symbol)) return Operator.ALWAYS_FALSE;
